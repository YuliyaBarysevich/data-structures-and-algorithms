...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const result = arr.reduce(arrLength, 0)
  function arrLength (acc){
    acc++;
    return acc;
  }
  return result;
...
const returnNames = (arr) => {
  // Solution code here...
  const result = arr.reduce(addNames, [])
  function addNames(array, value){
    if(value.name){
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  const result = arr.reduce(totalChildren, 0)
  function totalChildren(acc, value){
    if (value.children){
