...
const sortNumbers = (arr) => {
  // Solution code here...
  arr.sort(function(leftNum, rightNum){
    if (leftNum > rightNum){
      return 1;
...
const sortByPrice = (arr) => {
  // Solution code here...
  arr.sort(function(leftPrice, rightPrice){
    if (leftPrice.price > rightPrice.price){
      return 1;
    } else if (leftPrice.price < rightPrice.price) {
      return -1;
    } else {
      return 0;
    }
...
const alphabetizeBetter = (arr) => {
  // Solution code here...
  arr.sort(function(leftWord, rightWord){
    if (leftWord.toLowerCase() > rightWord.toLowerCase()){
      return 1;
    } else if (leftWord.toLowerCase() < rightWord.toLowerCase()){
      return -1;
    } else {
      return 0;
    }
...
const sortNumbersByLength = (arr) => {
  ...
  arr.sort(function(leftNumber, rightNumber){
    leftNumber = leftNumber.toString().length
    rightNumber = rightNumber.toString().length
...
const sortPeople = (arr) => {
  // Solution code here...
  arr.sort(function(leftPerson, rightPerson){
    leftPerson = leftPerson.lastName
    rightPerson = rightPerson.lastName
  ...
  arr.sort(function(leftPerson, rightPerson){
    ...
    if (leftPerson.lastName > rightPerson.lastName) {
      ...
      if (leftPerson.firstName > rightPerson.firstName) {
        return 1;
      } else if (leftPerson.firstName < rightPerson.firstName){
        return -1;
      }
      else {
        if (leftPerson.age > rightPerson.age) {
          return 1;
        } else if (leftPerson.age < rightPerson.age){
          return -1;
        } else {
          return 0;
        }
...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort(function(leftDay, rightDay){
    if (order[leftDay.dayOfWeek] > order[rightDay.dayOfWeek]){
      return 1;
    } else if (order[leftDay.dayOfWeek] < order[rightDay.dayOfWeek]) {
      return -1;
    } else {
      return 0;
    }
