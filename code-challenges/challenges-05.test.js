...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  starWarsArr.sort(function(leftPerson, rightPerson) {
    leftPerson = parseInt(leftPerson.height);
    rightPerson = parseInt(rightPerson.height);
...
const listFoods = (recipe) => {
  ...
  for (let i =0; i < gruffaloCrumble.ingredients.length; i++){
    ...
    let resultStr = gruffaloCrumble.ingredients[i].replace(regex, '');
